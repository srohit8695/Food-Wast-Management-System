...
/*
This data is visible for all the acceptor which
shows the donation food
*/

@Entity(tableName = "CommonFoodAcceptor")
public class CommonFoodAcceptor implements Parcelable {
    ...
    public CommonFoodAcceptor(String foodType, String foodName, String foodDated, String foodExpire, String foodQty, String donorName, String donorPh, String donorAdd, String latitude, String longitude, String userId) {
    ...
    protected CommonFoodAcceptor(Parcel in) {
        refId = in.readInt();
    ...
    public static final Creator<CommonFoodAcceptor> CREATOR = new Creator<CommonFoodAcceptor>() {
        @Override
        public CommonFoodAcceptor createFromParcel(Parcel in) {
            return new CommonFoodAcceptor(in);
        }

        @Override
        public CommonFoodAcceptor[] newArray(int size) {
            return new CommonFoodAcceptor[size];
        }
    };
